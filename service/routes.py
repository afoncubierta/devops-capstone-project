...
def list_accounts():
    """
    Lists all accounts
    This endpoint will provide a list of all accounts
    """
    app.logger.info("Request to list all Accounts")
    
    accounts = Account.all()
    number_of_accounts = len(accounts)
    app.logger.info(f"Retrieved {number_of_accounts} accounts")
    json_message = jsonify([account.serialize() for account in accounts])
